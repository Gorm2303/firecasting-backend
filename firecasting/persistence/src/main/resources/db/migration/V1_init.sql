...
CREATE INDEX idx_simrun_input_hash ON simulation_run(input_hash);
...
CREATE INDEX idx_summary_run ON yearly_summary(run_id);
CREATE INDEX idx_summary_phase_year ON yearly_summary(phase_name, year);
