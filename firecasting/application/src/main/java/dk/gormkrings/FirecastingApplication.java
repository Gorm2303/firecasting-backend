...
public class FirecastingApplication implements CommandLineRunner {
    ...
    public void runLocal() {
        ...
        ISpecification specification = specificationFactory.create(depositStartIDate.getEpochDay(), taxRule, "dataDrivenReturn", 1.02D);

        IAction deposit = new Deposit(10000, 10000, 0.5);
