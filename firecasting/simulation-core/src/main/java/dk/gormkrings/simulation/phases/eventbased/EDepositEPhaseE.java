...
@Getter
@Setter
public class EDepositEPhaseE extends ESimulationEPhase {
    private Deposit deposit;
    private boolean firstTime = true;

    public EDepositEPhaseE(Specification specification, Date startDate, long duration, Deposit deposit) {
    ...
    @Override
    public EDepositEPhaseE copy(Spec specificationCopy) {
        return new EDepositEPhaseE(
